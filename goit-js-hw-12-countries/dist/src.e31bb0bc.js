...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/toastr/build/toastr.min.css":[function(require,module,exports) {
...
const handleInputChange = e => {
  ...
  fetch(`https://restcountries.eu/rest/v2/name/${value}`).then(resp => resp.json()).then(data => {
    refs.countryList.innerHTML = '';
    refs.singleCountry.classList.remove('show');

    if (!data.map) {
      _toastr.default.error(data.message);
    ...
    if (data.length === 1) {
      ...
      _toastr.default.error('Too many matches found. Please enter a more specific query!');
    } else {
...
const debouncedHandleInputChange = (0, _lodash.default)(handleInputChange, 400);
refs.inputCountryName.addEventListener('input', debouncedHandleInputChange);
},{"lodash.debounce":"../node_modules/lodash.debounce/index.js","toastr":"../node_modules/toastr/toastr.js","toastr/build/toastr.min.css":"../node_modules/toastr/build/toastr.min.css","./sass/main.scss":"sass/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
